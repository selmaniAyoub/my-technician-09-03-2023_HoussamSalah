...
const Plan =({nextStep,values})=> {

const ChoosePlan1 = e => {
    e.preventDefault();
    values.plan= {id:Number(0)}
}
const ChoosePlan2 = e => {
    e.preventDefault();
    values.plan= {id:Number(1)}
}
const ChoosePlan3 = e => {
    e.preventDefault();
    values.plan= {id:Number(2)}
}
     const Continue = e => {
    e.preventDefault();
    nextStep();
...
<br/>
  <ul className="pricingTable-firstTable">
    <li className="pricingTable-firstTable_table">
      ...
      <button className="pricingTable-firstTable_table__getstart" onClick={ function(event){Continue(event) ; ChoosePlan1(event) }}>Get Started Now</button>
    </li>
    <li className="pricingTable-firstTable_table">
      ...
      <button className="pricingTable-firstTable_table__getstart" onClick={ function(event){Continue(event) ; ChoosePlan2(event) } }>Get Started Now</button>
    </li>
    <li className="pricingTable-firstTable_table">
      ...
      <button className="pricingTable-firstTable_table__getstart" onClick={ function(event){Continue(event) ; ChoosePlan3(event) } }>Get Started Now</button>
    </li>
  </ul>
</div>
