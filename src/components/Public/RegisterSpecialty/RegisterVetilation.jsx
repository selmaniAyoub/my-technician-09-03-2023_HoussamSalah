...
class RegisterVetilation extends Component {
    constructor(props) {
        super(props)
        this.state = {
            checked: false,
    ...
    handleSubmit = (event) => {
        ...
        if (validate) {
            const data = {
                ...
                experienceNumber,
                inami,
                profession: "veterinary1",
                speciality: null,
                photoUrl: "https://i.ibb.co/5BKXjMx/veterinary.png",
                photoCabinet: []
            }

            axios.post('http://192.168.1.113:5000/auth/signupveterinaire', data, {
                ...
                <MainContainer>
                    <StyledCard elevation={2}>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <LoginHeader variant='h1'>SignUp Survoyer
                            </LoginHeader>
                            <SideBySideInput>
...
export default withSnackbar(RegisterVetilation);