...
class RegisterDentist extends Component {
    constructor(props) {
        super(props)
        this.state = {
            checked: false,
    ...
    handleSubmit = (event) => {
        ...
        if (validate) {
            const data = {
                ...
                profession: "Dentist",
                speciality: null,
                photoUrl: "https://i.ibb.co/jWkkgxc/dentist.png",
                photoCabinet: [
                    "image-1url.com",
                    "https://i.ibb.co/YBB99tR/14247804-10210715325418278-1559331636-o.jpg"
                ]
            }

            axios.post('http://192.168.1.113:5000/auth/signupdentiste', data, {
                ...
                <MainContainer>
                    <StyledCard elevation={2}>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <LoginHeader variant='h1'>SignUp Capenter
                            </LoginHeader>
                            <SideBySideInput>
...
export default  withSnackbar(RegisterDentist);