...
class RegisterPsychologist extends Component {
    constructor(props) {
        super(props)
        this.state = {
            checked: false,
    ...
    handleSubmit = (event) => {
        ...
        if (validate) {
            const data = {
                ...
                speciality: null,
                photoUrl: "https://i.ibb.co/TWNQ1dL/psychologist.png",
                photoCabinet: []
            }

            axios.post('http://192.168.1.113:5000/auth/signuppsychologue', data, {
                ...
                <MainContainer>
                    <StyledCard elevation={2}>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <LoginHeader variant='h1'>SignUp Landscaper
                            </LoginHeader>
                            <SideBySideInput>
...
export default withSnackbar(RegisterPsychologist);