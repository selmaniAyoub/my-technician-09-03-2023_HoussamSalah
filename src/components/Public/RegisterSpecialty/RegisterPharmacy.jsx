    ...
    handleSubmit = (event) => {
        ...
        if (validate) {
            const data = {
                ...
                ville,
                experienceNumber,
                photoUrl: "https://i.ibb.co/6ZWTtVt/boss.png",
                photoPharmacie: []
            }

            axios.post('http://192.168.1.113:5000/auth/signuppharmacie', data, {
                ...
                <MainContainer>
                    <StyledCard elevation={2}>
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <LoginHeader variant='h1'>SignUp Welder
                            </LoginHeader>
                            <SideBySideInput>
...
export default withSnackbar(RegisterPharmacy);