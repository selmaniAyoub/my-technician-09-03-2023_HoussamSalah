...
const RenderDialogTitle = ({ id }) => {
    if (id) {
        return <DialogTitle>Edit diplômes</DialogTitle>
    }
    return <DialogTitle>Add diplômes</DialogTitle>
}
...
class DialogDiplome extends Component {
    constructor(props) {
        super(props)
        this.state = {
            id: null,
    ...
    componentDidUpdate(prevProps) {
        if (this.props.diplome !== prevProps.diplome) {
            if (this.props.diplome) {
                const { id, title, description, startDiplome, endDiplome, attachmentUrl, university } = this.props.diplome;
                this.setState({
                    id,
                    title,
                    description,
    ...
    handleSubmit = async (event) => {
        ...
        if (!id) {
            ...
            try {
                ...
                this.props.enqueueSnackbar("diplome added with success", { variant: "success", action: this.action });
        ...
        if (id) {
            const { title: _tile, description: _description, startDiplome: _startDiplome, endDiplome: _endDiplome, attachmentUrl: _attachmentUrl, university: _university } = this.props.diplome;
            ...
            if (title !== _tile || description !== _description || startDiplome !== _startDiplome || endDiplome !== _endDiplome || attachmentUrl !== _attachmentUrl || university !== _university) {
                ...
                try {
                    ...
                    this.setState({ loading: false })
                    this.props.enqueueSnackbar("diplome modified with success", { variant: "success", action: this.action });
                    data.id = id;
                    this.props.onClose(data);
                } catch (err) {
                    console.log(err)
...
export default withSnackbar(DialogDiplome) 