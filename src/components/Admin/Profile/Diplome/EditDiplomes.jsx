...
const RenderDateAndComp = ({ diplome }) => {
 ...
 function EditDiplomes({ user,t }) {
    ...
    const handleDeleteDiplome = (diplome) => () => {
        setLoading(true)
        axios.delete(`http://localhost:5000/profile/delete/diplome/${diplome.id}`)
            .then((res) => {
                setLoading(false)
                        ...
                        <ListHeader>
                            {
                                localDiplomes.length > 0 ?
                                    ...
                                    :
                                    <EmptyContainer>
                                        <EmptyText variant="body1">{t('Ajouter vos diplômes')}</EmptyText>
                                    </EmptyContainer>
                            }
...
export default compose (withNamespaces())(EditDiplomes);
