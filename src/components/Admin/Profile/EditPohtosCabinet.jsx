...
function EditPohtosCabinet(props,t) {
            ...
            return (
                <StyledAccordion expanded={expanded} onChange={handleChange} elevation={0}>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <BioTypo color={"primary"}>{props.t('Photos de cabinet')}</BioTypo>
                    </AccordionSummary>
                    <AccordionDetails>
                        {
                            Photos.length > 0 ?
                                ...
                                :
                                <EmptyContainer>
                                    <EmptyText  variant="body1">{props.t('Ajouter vos photos de cabinet')}</EmptyText>
                                </EmptyContainer>
                        }
                        <AddMediaFiles
                            files={Photos}
...
export default compose  (withSnackbar,withNamespaces())(EditPohtosCabinet);