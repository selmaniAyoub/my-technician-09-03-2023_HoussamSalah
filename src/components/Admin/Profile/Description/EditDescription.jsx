...
const AddOrEditDialog = ({ description, handleClickOpen }) => {
 ...
 function EditDescription({ user, t }) {
        ...
        if (role !== "client" && role !== "admin") {
            return (
                <Paper style={{ padding: "1.5em 1em" }} elevation={0}>
                    <ListHeader>
                        <BioTypo color={"primary"}>{t('description')}</BioTypo>
                    ...
                    </ListHeader>
                    {
                        localDescription ?
                            ...
                            :
                            <EmptyContainer>
                                <EmptyText variant="body1">{t('Ajouter votre description')}</EmptyText>
                            </EmptyContainer>
                    }
                    <DialogDescription
                        open={open}
...
export default compose (withNamespaces())(EditDescription);