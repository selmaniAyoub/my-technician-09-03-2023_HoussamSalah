...
const MsgMenu = (props) => {
    const { open, handleTooltipOpen, handleTooltipClose, handleRemove, loading } = props;
    ...
    if (type === "photos") {
        return (
            <MessageContent onMouseEnter={handleMouseEnter}
                ...
                <MessageCotnainer>
                    <SingleMessage>
                        <PhotoMessage owner={"me"} images={images} />
    ...
    if (type === "text") {
        return (
            <MessageContent onMouseEnter={handleMouseEnter}
                ...
                <MessageCotnainer>
                    <SingleMessage>
                        <TextMessage content={content} owner={"me"} />
                        <MsgTime>{`${sender}: ${RenderTime(time)}`}</MsgTime>
                    </SingleMessage>
                    <Avatar style={{ marginBottom: 20 }} alt="Remy Sharp" src={avatarUrl} />
                </MessageCotnainer>
        ...
        return (
            <MessageContent onMouseEnter={handleMouseEnter}
                ...
                <MessageCotnainer>
                    <SingleMessage>
                        <TextMessage content={content} owner={"me"} />
                        <PhotoMessage images={images} owner={"me"} />
                        <MsgTime>{`${sender}: ${RenderTime(time)}`}</MsgTime>
                    </SingleMessage>
                    <Avatar style={{ marginBottom: 20 }} alt="Remy Sharp" src={avatarUrl} />
                </MessageCotnainer>
