...
export default function EditCertification({ user }) {
    ...
    const handleDeleteCertification = (certification) => () => {
        setLoading(true)
        axios.delete(`http://192.168.1.113:5000/profile/delete/diplome/${certification.id}`)
            .then((res) => {
                setLoading(false)
            ...
            return (
                <StyledAccordion expanded={expanded} onChange={handleChange} elevation={0}>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <BioTypo color={"primary"}>Certifications</BioTypo>
                    </AccordionSummary>
                    <AccordionDetails>
                        <ListHeader>
                            {
                                localCertification.length > 0 ?
                                    ...
                                    :
                                    <EmptyContainer>
                                        <EmptyText variant="body1">Ajouter vos certifications</EmptyText>
                                    </EmptyContainer>
                            }
