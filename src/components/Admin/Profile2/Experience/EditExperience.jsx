...
export default function EditExperience({ user }) {
    ...
    const handleDeleteExperience = (experience) => () => {
        setLoading(true)
        axios.delete(`https://api.my-health-network.be/profile/delete/experience/${experience.id}`)
            .then((res) => {
                setLoading(false)
        ...
        if (role !== "client" && role !== "pharmacie") {
            return (
                <ExperienceSection elevation={0}>
                    <ListHeader>
                        <BioTypo color={"primary"}>Expériences</BioTypo>
                    ...
                    <ListExperience>
                        {
                            localExperiences.length > 0 ?
                                ...
                                :
                                <EmptyContainer>
                                    <EmptyText variant="body1">Ajouter votre expérience</EmptyText>
                                </EmptyContainer>
                        }
                    </ListExperience>
                    <DialogExperience
