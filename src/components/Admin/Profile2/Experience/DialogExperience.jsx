    ...
    handleSubmit = async (event) => {
        ...
        if (!id) {
            ...
            try {
                ...
                await axios.post('https://api.my-health-network.be/profile/add/experience', data)
        ...
        if (id) {
            ...
            if (title !== _tile || description !== _description || startExperience !== _startExperience || endExperience !== _endExperience || attachmentUrl !== _attachmentUrl || company !== _company) {
                ...
                try {
                    ...
                    await axios.put(`https://api.my-health-network.be/profile/update/experience/${id}`, data)
                    this.setState({ loading: false })
