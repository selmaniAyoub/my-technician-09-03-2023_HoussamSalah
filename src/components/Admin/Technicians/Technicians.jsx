...
export default class Technicians extends Component {
    ...
    render() {
        ...
        return (
            <Container>
                <TechniciansTable handleUnban={this.handleUnban} handleBan={this.handleBan} handleRemoveUser={this.handleRemove} technicians={technicians} handleConfirme={this.handleConfirm} />
            </Container>
        );
    }
}
